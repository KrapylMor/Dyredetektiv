...
function renderMission(id){
 ...
 shell(`<section class="game">
   <div class="hero"><div><div class="emoji">${m.emoji}</div><h1>${esc(m.title)}</h1><div class="subtitle">Mission ${m.id}</div></div></div>
   <div class="body">${progressBlock()}
...
function answerMission(m,btn){
 ...
 f.innerHTML=`<div class="card success"><div class="kicker">🎉 Godt klaret</div>
  ...
  <div class="card clue"><div class="kicker">🔍 Næste mission</div><p>${esc(m.clue)}</p></div>`;
}
